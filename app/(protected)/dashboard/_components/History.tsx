                    ...
                    <CardTitle className="grid grid-flow-row justify-between gap-2 md:grid-flow-col">
                        ...
                        <div className="flex h-10 gap-2">
                            <Badge variant={"outline"} className="flex items-center gap-2 text-sm">
                                <div className="h-4 w-4 rounded-full bg-emerald-500"></div>Renda
                            </Badge>

                            <Badge variant={"outline"} className="flex items-center gap-2 text-sm">
                                <div className="h-4 w-4 rounded-full bg-red-500"></div>Despesa
                            </Badge>
                        </div>
                    </CardTitle>
                </CardHeader>
                            ...
                            !dataAvailable && (
                                <Card className="flex h-[300px] flex-col items-center justify-center bg-background">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Tente selecionar um período diferente ou tente adicionar uma nova transação
                                    </p>
                                </Card>
                            )
                        }
